...
<head>
    ...
    @else
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/assets/admin/img/favicon-def.png')  }}">
    @endif
    ...
    <!-- Feathericon CSS -->
    <link rel="stylesheet" href="{{ asset('public/assets/admin/css/feathericon.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('public/assets/admin/js/chart.morris.js') }}"></script>
    ...
    <script src="{{ asset('public/assets/admin/js/feather.min.js') }}"></script>
