<link rel="shortcut icon" type="image/png" href="<?php echo e(asset('public/backend/assets/images/icon/favicon.ico')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('public/backend/assets/css/bootstrap.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('public/backend/assets/css/font-awesome.min.css')); ?>">
...
<link rel="stylesheet" href="<?php echo e(asset('public/backend/assets/css/owl.carousel.min.css')); ?>">
...
<!-- modernizr css -->
<script src="<?php echo e(asset('public/backend/assets/js/vendor/modernizr-2.8.3.min.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\Project\laravel-role\resources\views/backend/layouts/partials/styles.blade.php ENDPATH**/ ?>