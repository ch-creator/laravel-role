...
<?php echo e(__('Roles - Admin Panel')); ?>
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left"><?php echo e(__('Roles')); ?></h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
                    <li><span><?php echo e(__('All Roles')); ?></span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left"><?php echo e(__('Roles')); ?></h4>
                        ...
                        <table id="dataTable" class="text-center">
                            <thead class="bg-light text-capitalize">
                                <tr>
                                    ...
                                    <th width="60%"><?php echo e(__('Permissions')); ?></th>
                                    ...
                                    <td>
                                        ...
                                        <?php if(auth::user()->can('admin.edit')): ?>
                                            <a class="btn btn-danger text-white" href="javascript:void(0);"
                                                onclick="event.preventDefault(); if(confirm('Are you sure to delete?')) { document.getElementById('delete-form-<?php echo e($role->id); ?>').submit(); }">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Project\laravel-role\resources\views/backend/pages/roles/index.blade.php ENDPATH**/ ?>